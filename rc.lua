...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "www", "term", "music", "chat", "gimp", "pavu", "obs", "kden", "vlc" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
	...
	--awful.util.spawn("pavucontrol") end,
				--{description = "volume-control" , group = "applications"}),
    -- spotify 
	--awful.key({ modkey },            "m",     function () 
	--awful.util.spawn("spotify") end,
				--{description = "Music" , group = "applications"}),
    
	--Discord 
	--awful.key({ modkey },            "d",     function () 
	--awful.util.spawn("Discord") end,
				--{description = "Chat" , group = "applications"}),
	...
	--awful.util.spawn("kdenlive") end,
			--{description = "kdenlive" , group = "applications"}),
	-- gimp
	...
	--awful.util.spawn("vlc") end,
			--{description = "vlc" , group = "applications"}),


--how to use keybindings up top 
    awful.key({ modkey }, "x",
              function ()
                  awful.prompt.run {
                    prompt       = "Run Lua code: ",
